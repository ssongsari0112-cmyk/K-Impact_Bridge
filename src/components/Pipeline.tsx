...
export default function Pipeline() {
  return (
    <section id="pipeline" className="scroll-mt-20 bg-white px-6 py-24">
      <div className="mx-auto max-w-6xl">
        <div className="mx-auto max-w-2xl text-center">
          <p className="text-sm font-medium text-blue-600">서비스 작동 방식</p>
            ...
            return (
              <div key={step.label} className="flex shrink-0 items-start">
                <div className="flex w-28 flex-col items-center text-center">
                  ...
                  <p className="mt-3 text-xs font-medium leading-snug text-slate-600">
                    {step.label}
                  </p>
                </div>
                {!isLast && (
                  <div className="relative mx-1 mt-7 h-px w-10 shrink-0 bg-blue-100 sm:w-14 lg:w-full">
                    <span
                      className="absolute top-1/2 h-1.5 w-1.5 -translate-y-1/2 rounded-full bg-blue-600 shadow-[0_0_6px_#93c5fd] [animation:move-right_2.4s_linear_infinite]"
